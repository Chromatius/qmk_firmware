...
#define KC_MAC_DOLLAR LALT(KC_4)
 ...
 const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     [_WORKMAN] = LAYOUT(
         ...
         KC_BSPC,         HOME_A,   HOME_S,    HOME_H,   HOME_T,    KC_G,                                                                                                    KC_Y,             HOME_N,        HOME_E,      HOME_O,    HOME_I,    SE_ODIA,
     ...
     [_QWERTY] = LAYOUT(
         ...
         KC_BSPC,         QHOME_A,  QHOME_S,   QHOME_D,  QHOME_F,   KC_G,                                                                                                    KC_H,             QHOME_J,       QHOME_K,     QHOME_L,   QHOME_ODIA, SE_ADIA,
     ...
     [_SYMBOLSLEFT] = LAYOUT(
         ...
         _______, SE_SCLN, SE_COLN, SE_LPRN, SE_RPRN, KC_HASH,                                       KC_NO,   KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI, KC_NO,
     ...
     [_SYMBOLSRIGHT] = LAYOUT(
         ...
         _______, KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, KC_NO,                                      SE_PLUS, SE_EQL,  SE_CIRC, SE_UNDS, SE_DQUO, SE_APOS,
     ...
     [_NUMPAD] = LAYOUT(
         ...
         _______, SE_PLUS, KC_4,  KC_5,  KC_6,  KC_NO,                                   KC_NO, KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI, KC_NO,
     ...
     [_FN] = LAYOUT(
         ...
         _______, KC_F11, KC_F4, KC_F5,  KC_F6,  KC_NO,                                       KC_NO,   KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI, KC_NO,
     ...
     [_NAV] = LAYOUT(
         ...
         _______, KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, KC_NO,                                    KC_CAPS_LOCK,     KC_LEFT,         KC_DOWN,         KC_UP,           KC_RIGHT,     KC_NO,
         KC_NO,   KC_NO,   KC_NO,   KC_NO,    KC_NO,   KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO, KC_INSERT,        KC_HOME,         KC_PGDN,         KC_PGUP,         KC_END,       KC_NO,
